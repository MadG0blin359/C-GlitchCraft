...
if (drink_Quantity>coke_Available || drink_Quantity>pepsi_Available || drink_Quantity>sprite_Available || drink_Quantity>sevenUP_Available) {
	...
	if (drink_Number==1) {
		...
		printf("\nUnfortunately, we currently don't have the requested (%d) quantity of Coke, but the maximum available quantity has been ordered.\n", drink_Quantity);
		}
	}
		...
		printf("\nUnfortunately, we currently don't have the requested (%d) quantity of Pepse, but the maximum available quantity has been ordered.\n", drink_Quantity);
		}
	} 
		...
		printf("\nUnfortunately, we currently don't have the requested (%d) quantity of Sprite, but the maximum available quantity has been ordered.\n", drink_Quantity);
		}
	} 
...
int userInput(int coke_Available, int pepsi_Available, int sprite_Available, int sevenUP_Available) {
...
int main() {
	...
	int drink_Quantity = userInput(coke_Available, pepsi_Available, sprite_Available, sevenUP_Available);
	
	if (drink_Quantity>coke_Available) {
		
		checkAvailability(0, drink_Quantity, coke_Available, pepsi_Available, sprite_Available, sevenUP_Available);
		
		calculateBill(0, drink_Quantity, coke_Available, pepsi_Available, sprite_Available, sevenUP_Available, coke_Price, pepsi_Price, sprite_Price, sevenUP_Price);
